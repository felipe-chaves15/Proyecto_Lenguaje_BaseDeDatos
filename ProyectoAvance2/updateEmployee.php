...
<html>
    ...
    <form class="form-login" id="loginForm" name="loginForm" method="post" autocomplete="on">        
        ...
        <p>
            <label for="new_tarea_proyecto">Tareas de proyectos</label>
            <input class="controls" type="text" id="new_tarea_proyecto" name="new_tarea_proyecto" placeholder="Indique las tareas del proyecto" value="<?php echo htmlspecialchars($tarea_proyecto); ?>"/>
        </p>
