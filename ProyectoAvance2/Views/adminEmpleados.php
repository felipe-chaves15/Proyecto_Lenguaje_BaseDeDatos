    ...
    <body class="grid-container">
            ...
            <div class="container mt-4">
                <div class="d-flex justify-content-end mb-3">
                    ...
                    <a class="btn btn-primary" href="<?= ROOT ?>/registerEmployee.php">Nuevo Empleado</a>
                </div>
                <?php 
...
//Se puede ingresar usando un $ o usando JQuery
    ...
    $.ajax({
        url: "<?php echo ROOT; ?> /api/rest/employeeApi.php", 
        method: "POST",
        contentType: "application/x-www-form-urlencoded; charset=UTF-8",
        data:"deleteE=1&email=" + encodeURIComponent(email) 
    }).done(function(response) {
        const result = JSON.parse(response);
        if (result.success) {
            toastr.success("El Empleado ha sido eliminado exitosamente.");
            setTimeout(function() {
                location.reload();
