...
#navbar ul {
    ...
    <body class="grid-container">
        ...
        <br>
            <ul>
            <li><button class="button-nav" type="submit" href="#" id="principal" name="principal">Inicio</button></li>
                <li><button class="button-nav" type="submit" href="#" id="user" name="user">Mi perfil</button></li>
                <li><button class="button-nav" type="submit" href="#" id="categoria" name="categoria">Categoria</button></li>
                <li><button class="button-nav" type="submit" href="#" id="marca" name="marca">Marcas</button></li>
                <li><button class="button-nav" type="submit" href="#" id="producto" name="producto">Productos</button></li>
                <li><button class="button-nav" type="submit" href="#" id="carrito" name="carrito">Carrito</button></li>
                <li><button class="button-nav" type="submit" href="#" id="reporte" name="reporte">Factura</button></li>
            ...
            <?php
                ...
                elseif(isset($_POST["tarea"]))
                 ...
                 elseif(isset($_POST["reporte"]))
                 {
                     ...
                     include VIEWS_PATH . '/contenido.php';
